...
Restoration with GMVAE on training dataset, this aims to output result for different lambda chosen.
...
rho = np.arange(20)/5.0 # The range of lambda from 0 to 4
...
restoredata = 'CamCANT2'
MRtest, MRlabel = data_load(process = 'Test', dataset = 'CamCANT2', datapath = datapath)
